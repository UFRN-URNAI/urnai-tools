...
from urnai.agents.actions.mo_spatial_terran_wrapper import DefeatRoachesSimplified, DefeatRoachesSimplified_noop
...
def declare_trainer(): 
    ...
    trainer = Trainer(env, agent, save_path='../agentes-treinados-tcc/defeat-roaches', file_name="defeatroaches_simple10x10act",
                    ...
                    max_training_episodes=605, max_steps_training=300,
